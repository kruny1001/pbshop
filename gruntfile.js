...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        sass: {
            dev: {
                files: {
                    'public/css/style.css': 'public/style/style.scss'
            ...
            dist: {
                ...
                files: {
                    'public/dist/style.min.css': 'public/style/style.scss'
                }
            }
        }
    });
    ...
    // Build task(s).
    grunt.registerTask('build', ['lint', 'sass:dist', 'loadConfig', 'ngmin', 'uglify', 'cssmin']);
